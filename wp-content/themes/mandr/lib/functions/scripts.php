...
function mysite_register_script() {
	...
	# For galleria
	wp_register_script( MYSITE_PREFIX . '_galleria', esc_url ( THEME_JS . '/galleria/galleria-1.2.4.min.js' ), array('jquery'), THEME_VERSION );
	wp_register_script( MYSITE_PREFIX . '_galleria_classic', esc_url ( THEME_JS . '/galleria/themes/classic/galleria.classic.min.js' ), array('jquery'), THEME_VERSION, true );
